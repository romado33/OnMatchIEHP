...
export const Route = createFileRoute("/_authenticated/consent")({
  head: () => ({
    meta: [{ title: "Privacy & Terms — OnMatch Health" }],
  }),
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <ConsentItem
              ...
              description="Governs your use of OnMatch Health, including account responsibilities and acceptable conduct on the platform."
            />
            ...
            <div className="rounded-lg border border-border bg-muted/40 p-3 text-xs text-muted-foreground">
              OnMatch Health is designed for use by healthcare professionals and employers in Ontario, Canada. By
            ...
            <Button onClick={handleSubmit} disabled={!allChecked || loading} className="w-full">
              {loading ? "Saving…" : "Continue to OnMatch Health"}
            </Button>
          </CardContent>
        </Card>
      </div>
